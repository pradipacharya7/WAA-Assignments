package com.lab_10.solution.interceptor;
...
public class ProcessingTimeLogInterceptor implements HandlerInterceptor {
    ...
    private static final Logger LOGGER = Logger.getLogger(com.lab_10.solution.interceptor.ProcessingTimeLogInterceptor.class);
