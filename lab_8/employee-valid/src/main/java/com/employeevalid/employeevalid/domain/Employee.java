package com.employeevalid.employeevalid.domain;
...
//	 @NotBlank // must have characters BESIDES "space"
	...
	@Valid
	private com.employeevalid.employeevalid.domain.Address address;

	public com.employeevalid.employeevalid.domain.Address getAddress() {
		return address;
	}

	public void setAddress(com.employeevalid.employeevalid.domain.Address address) {
