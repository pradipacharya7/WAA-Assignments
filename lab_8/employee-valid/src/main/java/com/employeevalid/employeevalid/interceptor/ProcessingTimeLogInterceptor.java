package com.employeevalid.employeevalid.interceptor;
...
public class ProcessingTimeLogInterceptor implements HandlerInterceptor {
	...
	private static final Logger LOGGER = Logger.getLogger(com.employeevalid.employeevalid.interceptor.ProcessingTimeLogInterceptor.class);
