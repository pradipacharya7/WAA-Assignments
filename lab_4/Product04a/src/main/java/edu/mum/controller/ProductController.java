...
public class ProductController {
	...
	public List<Product> addProducts(Model model)
	{
    ...
    public String inputProduct(@ModelAttribute("products") Product product, Model model) {
	...
	@RequestMapping(value="/product", method = RequestMethod.POST)
     public String saveProduct(@ModelAttribute("products") Product product, Model model) {
